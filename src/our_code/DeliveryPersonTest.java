...
public class DeliveryPersonTest {  
	 ...
	 assertEquals(expectedString, "085 134");  
		 ...
		 boolean validatePhoneNo(String PhoneNo) throws DeliverypersonExceptionHandler { 
		 ...
		 return true; 
				 ...
				 throw new DeliverypersonExceptionHandler("PhoneNumber must be between 10 numbers"); 
	 ...
	 boolean validateAreaName(String DpName) throws DeliveryAreaExceptionHandler { 
